...
//	Copyright © 2016 by Kauã Melo. All rights reserved.



function leftEyebrow_l()
{
...
function leftEyebrow_c()
{
	...
	if(h < 40)
	{
		...
		translate(-hEB/2, -hEB/2);  					// back to the Face's center
		rotate(-radians(hEB));
    	translate(164, 25);
	...
	{
		// Positioning the origin on the eyebrow's left point
		translate(-164, -25);
		rotate(radians(12));
		translate(6, 6);
		...
		translate(1.5*(-hEB+12), 1.5*(-hEB+12));
		translate(-6, -6);  										// back to the Face's center
		rotate(-radians(12));
    	translate(164, 25);
	}
}
